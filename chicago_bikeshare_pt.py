...
def column_to_list(data, index):
    ...
    Argumentos:
        data: Arquivo no formato de dictionary.
...
for item in data_list:
    if item['Gender'].title() == 'Female':
        female += 1
    elif item['Gender'].title() == 'Male':
        male += 1
...
def most_popular_gender(data_list):
    '''
      Função que retorna a moda do gênero contido no data_list.
      Argumentos:
          data_list: Arquivo no formato de dictionary.
      Retorna:
...
answer = "O retorno da expressão é falso, porque existem clientes que não declararam seu sexo."
...
trip_list_length = len(trip_duration_list)
mean_trip /= trip_list_length

center = round(trip_list_length / 2)
...
def count_items(column_list):
    '''
      Função que verifica a quantidade de tipos de usuários.
      Argumentos:
          column_list: Lista de valores da coluna selecionada no column_list(). 
      Retorna:
